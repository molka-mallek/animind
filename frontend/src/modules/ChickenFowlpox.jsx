...
export default function ChickenFowlpox() {
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.header}>
        ...
        <div>
          <h1 className={styles.title}>Chicken Fowlpox Detection</h1>
          <p className={styles.subtitle}>Upload a clear chicken photo to screen for possible fowlpox.</p>
        </div>
      </div>
